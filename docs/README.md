...
# Edit .env file and add your ARC-3 API key and paths
```
...
**Environment Configuration**: Create a `.env` file with the following configuration including Windows-specific paths, all required variables, and proper documentation for each setting.
